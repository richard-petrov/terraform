...
The provider supports versions `3.13.x` to `3.10.x` of RabbitMQ. It may still work with versions `3.9.x` to `3.7.x`, however these versions are no longer officialy supported.
